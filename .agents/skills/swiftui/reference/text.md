...
## Contents
- [Modern Text Formatting](#modern-text-formatting)
- [Number Formatting](#number-formatting)
- [Currency Formatting](#currency-formatting)
- [Percentage Formatting](#percentage-formatting)
- [Date and Time Formatting](#date-and-time-formatting)
- [String Searching and Comparison](#string-searching-and-comparison)
...
```swift
let searchText = "cafe"
let items = ["Cafe Latte", "Coffee", "Tea"]
...
// Might not match "Cafe Latte" depending on normalization
```
