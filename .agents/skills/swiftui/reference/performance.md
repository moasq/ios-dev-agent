...
## Contents
- [Avoid Redundant State Updates](#avoid-redundant-state-updates)
- [Optimize Hot Paths](#optimize-hot-paths)
- [Pass Only What Views Need](#pass-only-what-views-need)
- [Equatable Views](#equatable-views)
- [POD Views for Fast Diffing](#pod-views-for-fast-diffing)
- [Lazy Loading](#lazy-loading)
- [Task Cancellation](#task-cancellation)
- [Debug View Updates](#debug-view-updates)
- [Eliminate Unnecessary Dependencies](#eliminate-unnecessary-dependencies)
- [Anti-Patterns](#anti-patterns)
- [AsyncImage Best Practices](#asyncimage-best-practices)
- [Image Downsampling (Optional Optimization)](#image-downsampling-optional-optimization)
